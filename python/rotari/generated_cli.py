...
CLI_SCHEMA: dict[str, Any] = {'commands': [{'description': 'generate a config file template',
              ...
              {'description': 'check whether a project is ready to run',
               'flags': [{'description': 'state directory',
                         ...
                         {'description': 'check local executables and working '
                                         'directories',
                          'name': 'deep'}],
               'name': 'check'},
              ...
              {'description': 'find and remove orphan run registry entries',
               'flags': [{'description': 'master registry directory',
                          'environment': 'ROTARI_MASTERDIR',
                          'name': 'masterdir',
                          'value_name': 'DIR'},
                         {'description': 'remove the cached orphan entries',
                          'name': 'apply'}],
               'name': 'gc'},
              ...
              {'description': 'execute queued commands, optionally selecting jobs from '
               ...
               'flags': [{'description': 'state directory',
                         ...
                         {'description': 'SSH executor concurrency',
                          ...
                          'value_name': 'N'},
                         {'description': 'SSH executor dispatch options; may be '
                                         'repeated',
                         ...
                         {'description': 'PBS executor concurrency',
                          ...
                          'value_name': 'N'},
                         {'description': 'PBS executor dispatch options; may be '
                                         'repeated',
                         ...
                         {'description': 'LSF executor concurrency',
                          ...
                          'value_name': 'N'},
                         {'description': 'LSF executor dispatch options; may be '
                                         'repeated',
              ...
              {'description': 'manage the background server',
               'flags': [{'description': 'state directory',
                         ...
                         {'description': 'server registry directory',
                          ...
                          'value_name': 'DIR'}],
               'name': 'server',
               'subcommands': [{'description': 'show server status', 'name': 'status'},
              ...
              {'description': 'print shell completion script',
               'name': 'completion',
               'subcommands': [{'description': 'bash completion', 'name': 'bash'},
                               {'description': 'zsh completion', 'name': 'zsh'},
                               {'description': 'fish completion', 'name': 'fish'},
                               {'description': 'install completion for the current '
                                               'shell',
                                'name': 'install'}]},
