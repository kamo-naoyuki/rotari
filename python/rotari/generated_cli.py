    ...
    "commands": [
        {
            ...
            "flags": [
                ...
                {"description": "output config file path", "name": "output", "value_name": "FILE"},
            ],
            "name": "config",
        },
        {
            ...
            "flags": [
                ...
                {"description": "check local executables and working directories", "name": "deep"},
                {"description": "suppress success output", "environment": "ROTARI_QUIET", "name": "quiet"},
            ],
            "name": "check",
            "positional": "[PROJECT]",
        },
        ...
        },
        {
            ...
            "flags": [
                ...
                {"description": "clear executor options", "name": "clear-executor-options"},
                {"description": "working directory for the job", "name": "working-directory", "value_name": "DIR"},
                {"description": "clear the job working directory", "name": "clear-working-directory"},
                {
                ...
                {"description": "replace job name", "name": "set-job-name", "value_name": "NAME"},
                {
        ...
        },
        {
            ...
            "flags": [
                ...
                {"description": "print a starter workflow manifest", "name": "template"},
                {"description": "write the workflow manifest to a file", "name": "output", "value_name": "FILE"},
            ],
            "name": "export",
        ...
        },
        {
            ...
            "flags": [
                ...
                {"description": "validate and print the import plan without writing", "name": "dry-run"},
        ...
        },
        {
            ...
            "flags": [
                ...
                {"description": "show the current queue even when a run is selected", "name": "queue"},
                {
                    "description": "job ID",
                    "environment": "ROTARI_JOB_ID",
                    "name": "job-id",
                ...
                {"description": "job name", "environment": "ROTARI_JOB_NAME", "name": "job-name", "value_name": "NAME"},
                {"description": "show failed jobs only", "name": "failed"},
                {"description": "show jobs in this stage only", "name": "stage", "value_name": "NAME"},
                {"description": "print output logs for all jobs", "name": "logs"},
                {"description": "print output logs for failed jobs", "name": "failed-logs"},
                {"description": "follow log output until the run completes", "name": "follow"},
                {"description": "print logs directly instead of using a pager", "name": "no-pager"},
                {"description": "list state directories known to the master registry", "name": "basedirs"},
                {"description": "print machine-readable JSON for a run", "name": "json"},
        ...
        },
        {
            ...
            "flags": [
                ...
                {"description": "include all basedirs known to the master registry", "name": "all"},
                {
        ...
        },
        {
            ...
            "flags": [
                ...
                {"description": "use local rule-based diagnosis without calling an LLM", "name": "rules"},
                {
                    "description": "LLM provider: openai, openai-chat, anthropic, gemini, or cohere",
                    "environment": "ROTARI_LLM_PROVIDER",
                    "name": "provider",
                    "value_name": "PROVIDER",
                    "values": ["openai", "openai-chat", "anthropic", "gemini", "cohere"],
                },
                {
        ...
        },
        {
            ...
            "flags": [
                ...
                {"description": "print each completed run as one JSON object", "name": "json"},
            ],
            "name": "wait",
        ...
        },
        {
            ...
            "flags": [
                ...
                {"description": "stage that contains the job", "name": "stage", "value_name": "NAME"},
                {
        ...
        },
        {
            ...
            "flags": [
                ...
                {"description": "include failed jobs; may be combined with result filters", "name": "failed"},
                {"description": "include unfinished jobs; may be combined with result filters", "name": "unfinished"},
                {"description": "include successful jobs; may be combined with result filters", "name": "success"},
                {
        ...
        },
        {
            ...
            "flags": [
                ...
                {"description": "replace a non-empty queue without prompting; requires --run-id", "name": "overwrite"},
                {
                ...
                {"description": "return after starting the run", "environment": "ROTARI_RUN_ASYNC", "name": "async"},
                {
        ...
        },
        {
            ...
            "subcommands": [
                ...
                {"description": "install completion for the current shell", "name": "install"},
            ],
        },
        {
