...
var diagnosisRules = []diagnosisRule{
	...
	{Name: "Python import or module missing", Patterns: []*regexp.Regexp{regexp.MustCompile(`modulenotfounderror`), regexp.MustCompile(`importerror`), regexp.MustCompile(`cannot import name`)}, Suggestion: "Check the Python environment, PYTHONPATH, package installation, and version compatibility."},
